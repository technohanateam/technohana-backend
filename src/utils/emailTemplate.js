...
export function generateEnrollmentConfirmationEmail({ name, courseTitle, trainingType, trainingPeriod, specialRequest, price, currency }) {
  return `
    <div style="font-family:sans-serif;line-height:1.6;">
      ...
      <p style="margin-top:2em;color:#888;">Best regards,<br/>SimpliGenAI Team</p>
    </div>
  `;
}
...
export function generateResumeAcknowledgementEmail({ name }) {
  return `
    <div style="font-family:sans-serif;line-height:1.6;">
      ...
      <p>Thank you for applying to SimpliGenAI. We have received your resume successfully.</p>
...
export function generateAIRiskReportRequestEmail({
  ...
  return `
    <div style="font-family:sans-serif;line-height:1.6;">
      ...
      <p style="margin-top:2em;color:#888;">Best regards,<br/>SimpliGenAI System</p>
    </div>
  `;
}
...
export function generatePaymentSuccessEmail({
  ...
  return `
    <div style="font-family:sans-serif;line-height:1.7;color:#111">
      ...
      <p style="margin:18px 0 0;color:#666">Best regards,<br/>SimpliGenAI Team</p>
    </div>
  `;
}
...
export function generateEnrollmentDetailsForSales({
  ...
  return `
    <div style="font-family:sans-serif;line-height:1.6;color:#111">
      ...
      <p style="margin-top:16px;color:#666">Generated by SimpliGenAI system.</p>
    </div>
  `;
}